...
(function () {
  ...
  async function skin() {
    ...
    var extra = '<style>' +
      '.pcard{background:#eef2fb;border:1px solid #c7d5ef;border-radius:10px;padding:12px 14px;margin:14px 0}' +
      ...
      '.jtab th{text-align:left;color:#6f6a6b;font-weight:600;padding:4px 8px;border-bottom:1px solid #c7d5ef}' +
      '.jtab td{padding:4px 8px;border-bottom:1px solid #eef2fb}' +
      '.jtab td.r,.jtab th.r{text-align:right}' +
      '.tag{display:inline-block;padding:1px 7px;border-radius:999px;font-size:11px;border:1px solid #c7d5ef}' +
      ...
      '.grp{border:1px solid #c7d5ef;border-radius:10px;margin-bottom:8px;overflow:hidden}' +
      '.ghead{display:flex;align-items:center;gap:10px;padding:10px 12px;background:#eef2fb;cursor:pointer}' +
      '.ghead:hover{background:#1e3a8a}' +
      ...
      '.ghead.gtot{background:#eef2fb;border:1px solid #c7d5ef;border-radius:10px;cursor:default;font-weight:700}' +
      '.gbody{padding:6px 10px 10px 10px;background:#eef2fb}' +
      '.btab td{padding:6px 8px}' +
        '.btab tr.bop td{background:#eef2fb;font-weight:600}' +
